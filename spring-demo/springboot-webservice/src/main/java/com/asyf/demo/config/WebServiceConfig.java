...
public class WebServiceConfig {
    ...
    public Endpoint endpoint() {
        ...
        //endpoint.setWsdlLocation("src/main/resources/api.wsdl");//本地的wsdl文件没有什么用
        //endpoint.setPublishedEndpointUrl("www.baidu.com");//设置 soap:address location
        //endpoint.setPublishedEndpointUrl("http://cloudpc-export.cpgroupcloud.com/ws/sapCostServer");
